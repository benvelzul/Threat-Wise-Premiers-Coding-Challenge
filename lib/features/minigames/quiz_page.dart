...
class MinigamesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final games = const [
      ...
      {'title': 'Access Control Matrix', 'subtitle': 'Navigate the security matrix', 'icon': Icons.lock_outline}
    ];
                ...
                itemBuilder: (context, index) {
                  final game = games[index];
                    return Ink(
                      child: InkWell(
                        onTap: () {
                          if (game['title'] == 'Access Control Matrix') {
                            Navigator.pushNamed(context, AccessControlMatrixDropPage.routeName);
                          } else {
