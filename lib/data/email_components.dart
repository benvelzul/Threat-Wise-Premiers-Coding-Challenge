...
class EmailComponents {
  ...
  static const Map<Difficulty, List<String>> phishingCTAs = {
    Difficulty.easy: [
      ...
      'Tap here now to prevent your account from being suspended:',
      'Verify your account using the button below:',
      'Click below to confirm your personal information:',
      'Open the secure verification page to restore access:',
      'Use the link below to complete your security check:',
    ],
    Difficulty.medium: [
      'Log into your portal within 24 hours to preserve access:',
      'Confirm your account details before the deadline expires:',
      'Sign in to review the recent security notification:',
      'Complete the required verification step from your dashboard:',
      'Access the employee portal to resolve this account issue:',
      'Review and approve the pending security request:',
    ],
    Difficulty.hard: [
      'Re-enter your credentials at the corporate portal below:',
      'Authenticate through the company sign-in page to continue:',
      'Use the internal access page to confirm your session:',
      'Sign in again to synchronise your account permissions:',
      'Verify your identity through the organisation’s access portal:',
      'Update your authentication details using the page below:',
    ],
    Difficulty.expert: [
      'Review the requested details here:',
      'Could you take a moment to confirm the information below?',
      'Please check the latest account activity when convenient:',
      'When you have a moment, review the attached request:',
      'Please verify that the details shown are correct:',
      'Take a quick look at the pending request:',
    ],
  };
